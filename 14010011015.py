...
def personel_maas_hesaplama(personel_dict):
    ...
    dönem=str(input("hangi aya ait maasi hesaplamak istersiniz?(Lütfen ay adını tamamı kücük harf olacak sekilde giriniz)"))
    ay=eval(dönem)
...
#çalışıyor
def menuden_cikis():
    print("Menüden cıkış fonk")
    tekrar = str(input("Menüye geri dönmek isterseniz e,cıkmak icin h ye basın"))
